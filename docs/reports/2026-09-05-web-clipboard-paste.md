...
- Live lane: run 1 failed before the new cases; corrected run pending. It also lacks bracket-off and bracket-on, Unicode, CRLF, and cancellation or error cases. Local success does not establish live acceptance.
