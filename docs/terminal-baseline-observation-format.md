...
Root retired the runner-specific execution requirement. This cold cut
implements that decision by removing the capture execution. The original
ticket waived the local record in `question_1787689401_836936` and the
controlled record in `question_1787678013_829162`. Those obligations belonged
to the retired requirement, so they are moot under that decision. The
historical decisions remain. No performance baseline was established. Future
work must still supply performance evidence.
