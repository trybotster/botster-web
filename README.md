...
- Encrypted daemon requests, responses, Core terminal frames, host `daemon_event`s, and pushed session entity frames travel over the ordered WebRTC data channel after DataChannel Hello.
