...
- Host-control v10 `ClientFrame` requests carry a monotonic decimal `request_id`; encrypted `ServerFrame` responses, host events, and typed close reasons travel over the ordered control DataChannel after its Hello. Web keeps at most 32 requests outstanding.
