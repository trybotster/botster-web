...
assert.match(architecture, /Control-channel `DaemonLocalWebrtcDeliveryChunk` frames carry/);
assert.match(architecture, /admitted channel carries only Core binary input frames/);
