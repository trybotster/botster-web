...
`@trybotster/hub-test-support@0.1.44` (`late-attach-history-conformance-fixture.json`,
conformance fixture revision 49, Hub 8cdab71, vendored at `test-support/hub-test-support`).
